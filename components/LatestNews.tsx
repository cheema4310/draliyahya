    ...
    <section id="latest" className="py-32 bg-navy-950 relative">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          <span className="text-medical-400 font-bold uppercase tracking-widest text-xs mb-3 block">Upcoming</span>
          <h2 className="text-4xl md:text-5xl font-display font-bold text-white">Latest Updates</h2>
        </div>
        ...
        >
          ...
          <div className="md:w-5/12 relative min-h-[300px] overflow-hidden">
            ...
            <div className="absolute top-6 left-6 bg-white/10 backdrop-blur-md border border-white/20 text-white px-4 py-3 rounded-xl text-center shadow-lg">
                <span className="block text-2xl font-bold leading-none font-display">12</span>
                <span className="block text-[10px] uppercase tracking-wider font-semibold">Feb</span>
            </div>
            <div className="absolute bottom-6 left-6 text-white z-10 max-w-xs">
               <p className="font-display italic text-lg leading-snug text-white/90">"Turn the Tide: Reimagine Pakistan 2030"</p>
            </div>
          </div>
          ...
          <div className="md:w-7/12 p-10 flex flex-col justify-center bg-navy-900/40">
            <div className="flex items-center gap-2 mb-4">
               ...
               <span className="text-xs font-bold uppercase tracking-widest text-medical-400">Featured Event</span>
            </div>
            ...
            <p className="text-gray-400 text-sm mb-8 font-medium">Karachi, Pakistan</p>
            ...
            <div className="space-y-6 mb-10">
              <div className="flex gap-5">
                ...
                <div>
                  <h5 className="font-bold text-white text-sm uppercase tracking-wide mb-1">Role</h5>
                  <p className="text-gray-400 text-sm">Featured as Dr. Ali Yahya — CEO, YQ Group</p>
                </div>
              </div>
              ...
              <div className="flex gap-5">
                ...
                <div>
                  <h5 className="font-bold text-white text-sm uppercase tracking-wide mb-1">Highlights</h5>
                  <p className="text-gray-400 text-sm">Book launch of “100 CEOs & Diplomats of Pakistan” and CEO Award Ceremony.</p>
                </div>
              </div>
            </div>
